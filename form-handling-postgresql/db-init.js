...
location_lng double precision,price money,
tags jsonb,
in_season boolean,
available boolean,
...
const createScript2 = `CREATE TABLE IF NOT EXISTS vacation_in_season_listeners (
...
client.connect().then(async () => {
    try {
        ...
        console.log('creating database schema2')
        await client.query(createScript2)
